...
public class Gen4RomHandler extends AbstractDSRomHandler {
    ...
    public List<Pokemon> bannedForWildEncounters() {
        // Ban all non ghost, dark, bug and psychic mons
        List<Pokemon> banned = new ArrayList<>();
        banned.add(pokes[Species.bulbasaur]);
        banned.add(pokes[Species.ivysaur]);
        banned.add(pokes[Species.venusaur]);
        banned.add(pokes[Species.charmander]);
        banned.add(pokes[Species.charmeleon]);
        banned.add(pokes[Species.charizard]);
        banned.add(pokes[Species.bulbasaur]);
        banned.add(pokes[Species.squirtle]);
        banned.add(pokes[Species.wartortle]);
        banned.add(pokes[Species.blastoise]);
        banned.add(pokes[Species.pidgey]);
        banned.add(pokes[Species.pidgeotto]);
        banned.add(pokes[Species.pidgeot]);
        banned.add(pokes[Species.rattata]);
        banned.add(pokes[Species.raticate]);
        banned.add(pokes[Species.spearow]);
        banned.add(pokes[Species.fearow]);
        banned.add(pokes[Species.ekans]);
        banned.add(pokes[Species.arbok]);
        banned.add(pokes[Species.pikachu]);
        banned.add(pokes[Species.raichu]);
        banned.add(pokes[Species.sandshrew]);
        banned.add(pokes[Species.sandslash]);
        banned.add(pokes[Species.nidoranFemale]);
        banned.add(pokes[Species.nidorina]);
        banned.add(pokes[Species.nidoqueen]);
        banned.add(pokes[Species.nidoranMale]);
        banned.add(pokes[Species.nidorino]);
        banned.add(pokes[Species.nidoking]);
        banned.add(pokes[Species.clefairy]);
        banned.add(pokes[Species.clefable]);
        banned.add(pokes[Species.vulpix]);
        banned.add(pokes[Species.ninetales]);
        banned.add(pokes[Species.jigglypuff]);
        banned.add(pokes[Species.wigglytuff]);
        banned.add(pokes[Species.zubat]);
        banned.add(pokes[Species.golbat]);
        banned.add(pokes[Species.oddish]);
        banned.add(pokes[Species.gloom]);
        banned.add(pokes[Species.vileplume]);
        banned.add(pokes[Species.diglett]);
        banned.add(pokes[Species.dugtrio]);
        banned.add(pokes[Species.meowth]);
        banned.add(pokes[Species.persian]);
        banned.add(pokes[Species.psyduck]);
        banned.add(pokes[Species.golduck]);
        banned.add(pokes[Species.mankey]);
        banned.add(pokes[Species.primeape]);
        banned.add(pokes[Species.growlithe]);
        banned.add(pokes[Species.arcanine]);
        banned.add(pokes[Species.poliwag]);
        banned.add(pokes[Species.poliwhirl]);
        banned.add(pokes[Species.poliwrath]);
        banned.add(pokes[Species.machop]);
        banned.add(pokes[Species.machoke]);
        banned.add(pokes[Species.machamp]);
        banned.add(pokes[Species.bellsprout]);
        banned.add(pokes[Species.weepinbell]);
        banned.add(pokes[Species.victreebel]);
        banned.add(pokes[Species.tentacool]);
        banned.add(pokes[Species.tentacruel]);
        banned.add(pokes[Species.geodude]);
        banned.add(pokes[Species.graveler]);
        banned.add(pokes[Species.golem]);
        banned.add(pokes[Species.ponyta]);
        banned.add(pokes[Species.rapidash]);
        banned.add(pokes[Species.magnemite]);
        banned.add(pokes[Species.magneton]);
        banned.add(pokes[Species.farfetchd]);
        banned.add(pokes[Species.doduo]);
        banned.add(pokes[Species.dodrio]);
        banned.add(pokes[Species.seel]);
        banned.add(pokes[Species.dewgong]);
        banned.add(pokes[Species.grimer]);
        banned.add(pokes[Species.muk]);
        banned.add(pokes[Species.shellder]);
        banned.add(pokes[Species.cloyster]);
        banned.add(pokes[Species.onix]);
        banned.add(pokes[Species.krabby]);
        banned.add(pokes[Species.kingler]);
        banned.add(pokes[Species.voltorb]);
        banned.add(pokes[Species.electrode]);
        banned.add(pokes[Species.cubone]);
        banned.add(pokes[Species.marowak]);
        banned.add(pokes[Species.hitmonlee]);
        banned.add(pokes[Species.hitmonchan]);
        banned.add(pokes[Species.lickitung]);
        banned.add(pokes[Species.koffing]);
        banned.add(pokes[Species.weezing]);
        banned.add(pokes[Species.rhyhorn]);
        banned.add(pokes[Species.rhydon]);
        banned.add(pokes[Species.chansey]);
        banned.add(pokes[Species.tangela]);
        banned.add(pokes[Species.kangaskhan]);
        banned.add(pokes[Species.horsea]);
        banned.add(pokes[Species.seadra]);
        banned.add(pokes[Species.goldeen]);
        banned.add(pokes[Species.seaking]);
        banned.add(pokes[Species.staryu]);
        banned.add(pokes[Species.electabuzz]);
        banned.add(pokes[Species.magmar]);
        banned.add(pokes[Species.tauros]);
        banned.add(pokes[Species.magikarp]);
        banned.add(pokes[Species.gyarados]);
        banned.add(pokes[Species.lapras]);
        banned.add(pokes[Species.ditto]);
        banned.add(pokes[Species.eevee]);
        banned.add(pokes[Species.vaporeon]);
        banned.add(pokes[Species.jolteon]);
        banned.add(pokes[Species.flareon]);
        banned.add(pokes[Species.porygon]);
        banned.add(pokes[Species.omanyte]);
        banned.add(pokes[Species.omastar]);
        banned.add(pokes[Species.kabuto]);
        banned.add(pokes[Species.kabutops]);
        banned.add(pokes[Species.aerodactyl]);
        banned.add(pokes[Species.snorlax]);
        banned.add(pokes[Species.articuno]);
        banned.add(pokes[Species.zapdos]);
        banned.add(pokes[Species.moltres]);
        banned.add(pokes[Species.dratini]);
        banned.add(pokes[Species.dragonair]);
        banned.add(pokes[Species.dragonite]);
        banned.add(pokes[Species.chikorita]);
        banned.add(pokes[Species.bayleef]);
        banned.add(pokes[Species.meganium]);
        banned.add(pokes[Species.cyndaquil]);
        banned.add(pokes[Species.quilava]);
        banned.add(pokes[Species.typhlosion]);
        banned.add(pokes[Species.totodile]);
        banned.add(pokes[Species.croconaw]);
        banned.add(pokes[Species.feraligatr]);
        banned.add(pokes[Species.sentret]);
        banned.add(pokes[Species.furret]);
        banned.add(pokes[Species.hoothoot]);
        banned.add(pokes[Species.noctowl]);
        banned.add(pokes[Species.crobat]);
        banned.add(pokes[Species.chinchou]);
        banned.add(pokes[Species.lanturn]);
        banned.add(pokes[Species.pichu]);
        banned.add(pokes[Species.cleffa]);
        banned.add(pokes[Species.igglybuff]);
        banned.add(pokes[Species.togepi]);
        banned.add(pokes[Species.togetic]);
        banned.add(pokes[Species.mareep]);
        banned.add(pokes[Species.flaaffy]);
        banned.add(pokes[Species.ampharos]);
        banned.add(pokes[Species.bellossom]);
        banned.add(pokes[Species.marill]);
        banned.add(pokes[Species.azumarill]);
        banned.add(pokes[Species.sudowoodo]);
        banned.add(pokes[Species.politoed]);
        banned.add(pokes[Species.hoppip]);
        banned.add(pokes[Species.skiploom]);
        banned.add(pokes[Species.jumpluff]);
        banned.add(pokes[Species.aipom]);
        banned.add(pokes[Species.sunkern]);
        banned.add(pokes[Species.sunflora]);
        banned.add(pokes[Species.wooper]);
        banned.add(pokes[Species.quagsire]);
        banned.add(pokes[Species.dunsparce]);
        banned.add(pokes[Species.gligar]);
        banned.add(pokes[Species.steelix]);
        banned.add(pokes[Species.snubbull]);
        banned.add(pokes[Species.granbull]);
        banned.add(pokes[Species.qwilfish]);
        banned.add(pokes[Species.teddiursa]);
        banned.add(pokes[Species.ursaring]);
        banned.add(pokes[Species.slugma]);
        banned.add(pokes[Species.magcargo]);
        banned.add(pokes[Species.swinub]);
        banned.add(pokes[Species.piloswine]);
        banned.add(pokes[Species.corsola]);
        banned.add(pokes[Species.remoraid]);
        banned.add(pokes[Species.octillery]);
        banned.add(pokes[Species.delibird]);
        banned.add(pokes[Species.mantine]);
        banned.add(pokes[Species.skarmory]);
        banned.add(pokes[Species.kingdra]);
        banned.add(pokes[Species.phanpy]);
        banned.add(pokes[Species.donphan]);
        banned.add(pokes[Species.porygon2]);
        banned.add(pokes[Species.stantler]);
        banned.add(pokes[Species.smeargle]);
        banned.add(pokes[Species.tyrogue]);
        banned.add(pokes[Species.hitmontop]);
        banned.add(pokes[Species.elekid]);
        banned.add(pokes[Species.magby]);
        banned.add(pokes[Species.miltank]);
        banned.add(pokes[Species.blissey]);
        banned.add(pokes[Species.raikou]);
        banned.add(pokes[Species.entei]);
        banned.add(pokes[Species.suicune]);
        banned.add(pokes[Species.larvitar]);
        banned.add(pokes[Species.pupitar]);
        banned.add(pokes[Species.hoOh]);
        banned.add(pokes[Species.treecko]);
        banned.add(pokes[Species.grovyle]);
        banned.add(pokes[Species.sceptile]);
        banned.add(pokes[Species.torchic]);
        banned.add(pokes[Species.combusken]);
        banned.add(pokes[Species.blaziken]);
        banned.add(pokes[Species.mudkip]);
        banned.add(pokes[Species.marshtomp]);
        banned.add(pokes[Species.swampert]);
        banned.add(pokes[Species.zigzagoon]);
        banned.add(pokes[Species.linoone]);
        banned.add(pokes[Species.lotad]);
        banned.add(pokes[Species.lombre]);
        banned.add(pokes[Species.ludicolo]);
        banned.add(pokes[Species.seedot]);
        banned.add(pokes[Species.taillow]);
        banned.add(pokes[Species.swellow]);
        banned.add(pokes[Species.wingull]);
        banned.add(pokes[Species.pelipper]);
        banned.add(pokes[Species.shroomish]);
        banned.add(pokes[Species.breloom]);
        banned.add(pokes[Species.slakoth]);
        banned.add(pokes[Species.vigoroth]);
        banned.add(pokes[Species.slaking]);
        banned.add(pokes[Species.whismur]);
        banned.add(pokes[Species.loudred]);
        banned.add(pokes[Species.exploud]);
        banned.add(pokes[Species.makuhita]);
        banned.add(pokes[Species.hariyama]);
        banned.add(pokes[Species.azurill]);
        banned.add(pokes[Species.nosepass]);
        banned.add(pokes[Species.skitty]);
        banned.add(pokes[Species.delcatty]);
        banned.add(pokes[Species.mawile]);
        banned.add(pokes[Species.aron]);
        banned.add(pokes[Species.lairon]);
        banned.add(pokes[Species.aggron]);
        banned.add(pokes[Species.electrike]);
        banned.add(pokes[Species.manectric]);
        banned.add(pokes[Species.plusle]);
        banned.add(pokes[Species.minun]);
        banned.add(pokes[Species.roselia]);
        banned.add(pokes[Species.gulpin]);
        banned.add(pokes[Species.swalot]);
        banned.add(pokes[Species.wailmer]);
        banned.add(pokes[Species.wailord]);
        banned.add(pokes[Species.numel]);
        banned.add(pokes[Species.camerupt]);
        banned.add(pokes[Species.torkoal]);
        banned.add(pokes[Species.spinda]);
        banned.add(pokes[Species.trapinch]);
        banned.add(pokes[Species.vibrava]);
        banned.add(pokes[Species.flygon]);
        banned.add(pokes[Species.cacnea]);
        banned.add(pokes[Species.swablu]);
        banned.add(pokes[Species.altaria]);
        banned.add(pokes[Species.zangoose]);
        banned.add(pokes[Species.seviper]);
        banned.add(pokes[Species.barboach]);
        banned.add(pokes[Species.whiscash]);
        banned.add(pokes[Species.corphish]);
        banned.add(pokes[Species.lileep]);
        banned.add(pokes[Species.cradily]);
        banned.add(pokes[Species.anorith]);
        banned.add(pokes[Species.armaldo]);
        banned.add(pokes[Species.feebas]);
        banned.add(pokes[Species.milotic]);
        banned.add(pokes[Species.castform]);
        banned.add(pokes[Species.kecleon]);
        banned.add(pokes[Species.tropius]);
        banned.add(pokes[Species.snorunt]);
        banned.add(pokes[Species.glalie]);
        banned.add(pokes[Species.spheal]);
        banned.add(pokes[Species.sealeo]);
        banned.add(pokes[Species.walrein]);
        banned.add(pokes[Species.clamperl]);
        banned.add(pokes[Species.huntail]);
        banned.add(pokes[Species.gorebyss]);
        banned.add(pokes[Species.relicanth]);
        banned.add(pokes[Species.luvdisc]);
        banned.add(pokes[Species.bagon]);
        banned.add(pokes[Species.shelgon]);
        banned.add(pokes[Species.salamence]);
        banned.add(pokes[Species.regirock]);
        banned.add(pokes[Species.regice]);
        banned.add(pokes[Species.registeel]);
        banned.add(pokes[Species.kyogre]);
        banned.add(pokes[Species.groudon]);
        banned.add(pokes[Species.rayquaza]);
        banned.add(pokes[Species.turtwig]);
        banned.add(pokes[Species.grotle]);
        banned.add(pokes[Species.torterra]);
        banned.add(pokes[Species.chimchar]);
        banned.add(pokes[Species.monferno]);
        banned.add(pokes[Species.infernape]);
        banned.add(pokes[Species.piplup]);
        banned.add(pokes[Species.prinplup]);
        banned.add(pokes[Species.empoleon]);
        banned.add(pokes[Species.starly]);
        banned.add(pokes[Species.staravia]);
        banned.add(pokes[Species.staraptor]);
        banned.add(pokes[Species.bidoof]);
        banned.add(pokes[Species.bibarel]);
        banned.add(pokes[Species.shinx]);
        banned.add(pokes[Species.luxio]);
        banned.add(pokes[Species.luxray]);
        banned.add(pokes[Species.budew]);
        banned.add(pokes[Species.roserade]);
        banned.add(pokes[Species.cranidos]);
        banned.add(pokes[Species.rampardos]);
        banned.add(pokes[Species.shieldon]);
        banned.add(pokes[Species.bastiodon]);
        banned.add(pokes[Species.pachirisu]);
        banned.add(pokes[Species.buizel]);
        banned.add(pokes[Species.floatzel]);
        banned.add(pokes[Species.cherubi]);
        banned.add(pokes[Species.cherrim]);
        banned.add(pokes[Species.shellos]);
        banned.add(pokes[Species.gastrodon]);
        banned.add(pokes[Species.ambipom]);
        banned.add(pokes[Species.buneary]);
        banned.add(pokes[Species.lopunny]);
        banned.add(pokes[Species.glameow]);
        banned.add(pokes[Species.purugly]);
        banned.add(pokes[Species.stunky]);
        banned.add(pokes[Species.skuntank]);
        banned.add(pokes[Species.bonsly]);
        banned.add(pokes[Species.happiny]);
        banned.add(pokes[Species.chatot]);
        banned.add(pokes[Species.gible]);
        banned.add(pokes[Species.gabite]);
        banned.add(pokes[Species.garchomp]);
        banned.add(pokes[Species.munchlax]);
        banned.add(pokes[Species.riolu]);
        banned.add(pokes[Species.lucario]);
        banned.add(pokes[Species.hippopotas]);
        banned.add(pokes[Species.hippowdon]);
        banned.add(pokes[Species.skorupi]);
        banned.add(pokes[Species.drapion]);
        banned.add(pokes[Species.croagunk]);
        banned.add(pokes[Species.toxicroak]);
        banned.add(pokes[Species.carnivine]);
        banned.add(pokes[Species.finneon]);
        banned.add(pokes[Species.lumineon]);
        banned.add(pokes[Species.mantyke]);
        banned.add(pokes[Species.snover]);
        banned.add(pokes[Species.abomasnow]);
        banned.add(pokes[Species.magnezone]);
        banned.add(pokes[Species.lickilicky]);
        banned.add(pokes[Species.rhyperior]);
        banned.add(pokes[Species.tangrowth]);
        banned.add(pokes[Species.electivire]);
        banned.add(pokes[Species.magmortar]);
        banned.add(pokes[Species.togekiss]);
        banned.add(pokes[Species.glaceon]);
        banned.add(pokes[Species.leafeon]);
        banned.add(pokes[Species.mamoswine]);
        banned.add(pokes[Species.porygonZ]);
        banned.add(pokes[Species.probopass]);
        banned.add(pokes[Species.dialga]);
        banned.add(pokes[Species.palkia]);
        banned.add(pokes[Species.heatran]);
        banned.add(pokes[Species.regigigas]);
        banned.add(pokes[Species.manaphy]);
        banned.add(pokes[Species.phione]);
        banned.add(pokes[Species.shaymin]);
        banned.add(pokes[Species.arceus]);
        return banned;
    }
